...
public class BusquedaClienteController implements ActionListener, KeyListener, MouseListener {
    ...
    public void actionPerformed(ActionEvent e) {
        if (e.getSource() == busquedaCliente.btn_busq_cliente_select) {
            ...
            //Antes de buscar, validar que existan datos para hacer la búsqueda!
            if (busquedaCliente.txt_busqueda_cliente_apellido.getText().equals("")
                    && busquedaCliente.txt_busqueda_cliente_nombre.getText().equals("")
                    && busquedaCliente.txt_busqueda_cliente_nro_cte.getText().equals("")
                    && busquedaCliente.txt_busqueda_cliente_nro_doc.getText().equals("")) {

                JOptionPane.showMessageDialog(null, "Debe ingresar al menos un criterio de búsqueda", "Advertencia",
