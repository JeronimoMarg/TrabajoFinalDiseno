    ...
    public void actionPerformed(ActionEvent e) {
        if (e.getSource() == altaPoliza02.btn_alta_poliza02_continuar) {
            if (elementoSeleccionado.equals("Ninguno")) {
                JOptionPane.showMessageDialog(null, "Debe seleccionar un tipo de cobertura.", "Error", JOptionPane.ERROR_MESSAGE);
            ...
            if (selectedDate != null) {
                ...
                if (fechaAnterior(selectedDate)) {
                    ...
                    if (fechaExcedida(selectedDate)) {
                        JOptionPane.showMessageDialog(null, "La fecha de inicio de cobertura no puede ser más de 1 mes desde hoy.", "Error", JOptionPane.ERROR_MESSAGE);
                    } else {
