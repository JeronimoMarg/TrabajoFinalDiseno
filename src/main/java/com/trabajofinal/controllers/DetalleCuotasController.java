...
public class DetalleCuotasController implements ActionListener {
    ...
    public DetalleCuotasController(DetalleCuotas detalleCuotas, List<Cuota> cuotas) {
    ...
    private void cargar() {
        ...
        if (cuotas.size() == 6) {
            ...
            fechaFormateada = sdf.format(Date.from(cuotas.get(0).getFecha_vencimiento().atStartOfDay(ZoneId.systemDefault()).toInstant()));
            ...
            fechaFormateada = sdf.format(Date.from(cuotas.get(1).getFecha_vencimiento().atStartOfDay(ZoneId.systemDefault()).toInstant()));
            ...
            fechaFormateada = sdf.format(Date.from(cuotas.get(2).getFecha_vencimiento().atStartOfDay(ZoneId.systemDefault()).toInstant()));
            ...
            fechaFormateada = sdf.format(Date.from(cuotas.get(3).getFecha_vencimiento().atStartOfDay(ZoneId.systemDefault()).toInstant()));
            ...
            fechaFormateada = sdf.format(Date.from(cuotas.get(4).getFecha_vencimiento().atStartOfDay(ZoneId.systemDefault()).toInstant()));
            ...
            fechaFormateada = sdf.format(Date.from(cuotas.get(5).getFecha_vencimiento().atStartOfDay(ZoneId.systemDefault()).toInstant()));
