...
public class AltaPoliza01Controller implements ActionListener, KeyListener, MouseListener {
    ...
    public AltaPoliza01Controller(AltaPoliza01 altaPoliza01, ClienteDTO cliente) {
        ...
        Thread hiloDatos = new Thread() {
            ...
            public void run() {
                ...
                listarHijos();   //vamos anecesitar recuperar los datos de los hijos de la tabla y buscar los que le corresponden al cliente seleccionado
    ...
    private boolean validar() {        return !(altaPoliza01.txt_alta_pol01_chasis.getText().equals("")
